...
HD_PWD='C:/Users/nik/MSiS/lab3/lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nexys_rf_riscv.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nexys_rf_riscv.tcl
