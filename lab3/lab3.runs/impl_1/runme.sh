...
HD_PWD='C:/Users/nik/MSiS/lab3/lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nexys_rf_riscv.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nexys_rf_riscv.tcl -notrace
