...
HD_PWD='C:/Users/nik/lab2/lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_riscv.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source alu_riscv.tcl -notrace
